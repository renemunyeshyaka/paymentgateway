...
public class EmailService {
    ...
    public void sendActivationEmail(String toEmail, String userName) {
        ...
        if (!isEmailConfigured()) {
            ...
            System.out.println("Activation Link: http://localhost:8080/api/auth/activate?email=" + toEmail);
            //System.out.println("Activation Link: http://dpg-d3r70femcj7s73bmmfe0-a.oregon-postgres.render.com:8080/api/auth/activate?email=" + toEmail);
            System.out.println("=======================================");
            return;
        }
    ...
    private String buildActivationEmailContent(String userName, String email) {
        String activationLink = "http://localhost:8080/api/auth/activate?email=" + email;
